...
<head>
    ...
    <title>Internships - Youth Job & Internship Finder</title>
...
<section class="jobs-section">
    <div class="jobs-container">
        <h2>Internships</h2>
        <p>Browse internship listings from vetted companies. Content is loaded from the backend as this feature grows.</p>
    </div>
</section>
